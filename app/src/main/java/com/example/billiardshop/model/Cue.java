...
import com.example.billiardshop.view.activity.CueDetailActivity;
...
public class Cue extends BaseObservable implements Serializable {
    @PrimaryKey
    private int id;
    private String name;
    ...
    public void goToCueDetail(View view) {
        Bundle bundle = new Bundle();
        bundle.putSerializable(Constant.KEY_INTENT_CUE_OBJECT, this);
        GlobalFuntion.startActivity(view.getContext(), CueDetailActivity.class, bundle);
    ...
    public void onClickButtonSubtract(View view) {
        ...
        iClickItemCartListener.updateItemCue(view.getContext(), this, getAdapterPosition());
    }
    ...
    public void onClickButtonDelete(View view) {
        iClickItemCartListener.clickDeteteCue(view.getContext(), this, getAdapterPosition());
    }
